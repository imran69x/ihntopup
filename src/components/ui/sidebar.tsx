  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=collapsed]:peer-data-[variant=floating]:peer-data-[collapsible=icon]:ml-[calc(var(--sidebar-width-icon)+theme(spacing.4))]",
        "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:peer-data-[collapsible=icon]:ml-[calc(var(--sidebar-width-icon)+theme(spacing.4))]",
        className
      )}
      {...props}
    />
